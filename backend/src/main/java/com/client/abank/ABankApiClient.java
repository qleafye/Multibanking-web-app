        ...
        try {
            ...
            return bankTransactions.stream()
                    .map(bankDto -> {
                        ...
                        //    ВАЖНО: Имя метода getCreditDebitIndicator() — это ПРЕДПОЛОЖЕНИЕ.
                        //    Нужно найти в классе ABankTransactionDto правильное имя метода,
                        //    который возвращает "Debit" или "Credit".
